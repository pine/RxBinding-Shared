 ...
 */
fun CompoundButton.sharedCheckedChanges(): Observable<Boolean> {
    return CachedObservable.getOrCreate(this, ObservableType.CompoundButtonCheckedChanges) {
        RxCompoundButton.checkedChanges(this)
    }
}